...
const techStack = [
    {
        category: "Frontend",
        items: ["React.js", "Angular.js", "TypeScript"],
    },
    {
        category: "Styling",
...
const aboutLocation = {
    ...
    children: [
        ...
        },
        {
            ...
            description: [
                "Hey! I’m Suneesh S 👋, a web developer who enjoys building sleek, interactive websites that actually work well.",
                "I specialize in JavaScript, React, and Angular.js and I love making things feel smooth, fast, and just a little bit delightful.",
...
export { navLinks, navIcons, dockApps, techStack, socials, photosLinks, gallery, locations, windowConfig };